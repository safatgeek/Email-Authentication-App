...
export async function fetchUserInfo(firebaseId: string): Promise<any> {
  const apiUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/user/${firebaseId}`; // Use environment variable for base URL
